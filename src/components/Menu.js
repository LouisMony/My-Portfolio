...
export default class Menu extends React.Component {
    ...
    componentDidMount(){
        const titlemenu = Array.from(document.querySelectorAll('.Menu__item'))
        titlemenu.forEach(item => {
            let title = item.querySelector('.Menu__item__left__title')
            item.addEventListener('mouseleave', function(){
                title.classList.remove('MonicaFont', 'js_ActiveItem')
            })
            item.addEventListener('mouseenter', function(){
                title.classList.add('MonicaFont', 'js_ActiveItem')
                gsap.fromTo('.js_ActiveItem', {translateY: "25vh",},{translateY: "0px",duration: 0.5})
            })
        ...
        <div className='Menu'>
            <Link to='/' className='Menu__item' onClick={this.MenuJsToggleIcon} >
                <div className='Menu__item__left'>
                    ...
                    <p className='Menu__item__left__title'>HOME</p>
                </div>
            ...
            <Link to="/projects" className='Menu__item' onClick={this.MenuJsToggleIcon}>
                <div className='Menu__item__left'>
            ...
            <Link to="/about-me" className='Menu__item' onClick={this.MenuJsToggleIcon}>
                <div className='Menu__item__left'>
            ...
            <Link to="/contact" className='Menu__item' onClick={this.MenuJsToggleIcon}>
                <div className='Menu__item__left'>
