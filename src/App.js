      ...
      <Route render={({ location }) => (
          <AnimatePresence exitBeforeEnter >
              ...
              <Route
                ...
                stack="Reactjs" time="Avril 2023" type="Personnal project" banner="/media/supreme_visual.webp" endCTA="Visit Website" nextCTA="/project/aides" endLink="https://supreme-rebranding.netlify.app/" introText="This fictional website for the Supreme brand is a personal rebranding project. The objective was not to create a new e-commerce site for the brand but rather a second site more focused on the presentation of the brand's universe and the new collections and collaborations." firstVisual="/media/content/Supreme_MockUp.webp" SecondVisual="/media/content/Supreme_MockUp.webp" scalebanner="2.3" transformbannner="-40"
                />}
              />
              <Route
                exact
