          ...
          <AnimatePresence exitBeforeEnter >
              ...
              />
               <Route
                ...
                stack="Fl Studio" time="September 2017" type="Personnal & professionnal project" banner="/media/music_visual.webp" endCTA="Listen to my music" endLink="https://soundcloud.com/user-937117132" introText="I have been producing music on the computer for over 6 years and publishing my work through various platforms such as SoundCloud, Deezer, etc. My compositions are mainly rap instrumentals, electronic and lo-fi. In 2021, I completed a project titled 'Little Boy' and with each new piece, I strive to create my own musical universe." secondText="In a professional setting, I have had the opportunity to work on projects for the Hyundai brand, including sound design for Instagram reels. Such projects are very rewarding and have allowed me to develop new technical skills." scalebanner="1.7" transformbannner="-10"
                />}
              />
              <Route
                exact
